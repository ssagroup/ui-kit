...
const gotoPage = (page: Page) => {
  return page.goto(
    'http://localhost:6007/iframe.html?args=&id=fintech-botstable--bots-table&viewMode=story',
  );
};
...
const gotoPageNoControlOrders = (page: Page) => {
  return page.goto(
    'http://localhost:6007/iframe.html?args=&id=fintech-botstable--no-control-orders&viewMode=story',
  );
};

...
Use the `name` prop to assign a name to the underlying button element. This helps address the component on a web form (e.g., for automated testing or form libraries that read DOM attributes).

...
type EventInfoPopoverTriggerProps = React.HTMLProps<HTMLElement> &
...
// paths, which are not portable in the emitted declarations (TS2742).
export const EventInfoPopoverTrigger: React.ForwardRefExoticComponent<
  EventInfoPopoverTriggerProps & React.RefAttributes<HTMLElement>
> = React.forwardRef<HTMLElement, EventInfoPopoverTriggerProps>(
